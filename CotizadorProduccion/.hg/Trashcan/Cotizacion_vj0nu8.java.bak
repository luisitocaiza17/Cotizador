...
@NamedQueries({
	...
	@NamedQuery(name="Cotizacion.buscarPorFactura", query="SELECT c FROM Cotizacion c where c.numeroFactura = :numeroFactura"),
	...
	@NamedQuery(name="Cotizacion.buscarRepetidos", query="SELECT c.numeroTramite FROM Cotizacion c WHERE c.tipoObjeto = :tipoObjeto and c.puntoVenta = :puntoVenta  GROUP BY c.numeroTramite HAVING COUNT(c.numeroTramite) > 1 "),
	...
	@NamedQuery(name="Cotizacion.buscarMaxIdTramites", query="SELECT max(c.id) FROM Cotizacion c where c.numeroTramite=:numeroTramite"),
...
public class Cotizacion implements Serializable {
  ...
  @Column(name="informacion_adicional")
	...
	@Column(name="agente_acuerdo")
	private String agenteAcuerdo;
  ...
  //bi-directional many-to-one association to Pago
	...
	public String getAgenteAcuerdo() {
		return agenteAcuerdo;
	}

	public void setAgenteAcuerdo(String agenteAcuerdo) {
		this.agenteAcuerdo = agenteAcuerdo;
	}
