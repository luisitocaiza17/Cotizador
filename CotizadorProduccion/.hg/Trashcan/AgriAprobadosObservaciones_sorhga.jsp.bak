...
<title>Cotizaciones Agr&iacute;cola Aprobados con Observaciones- CotizadorQBE</title>
...
function GetQueryStringByParameter(name) {
	...
	$(document).ready(function() {
			activarMenu("AgriAprobadosObservaciones");
			$("#loading").hide();
			$("#reporteEndosos").hide();			
			$("#reporteCotizacion").hide();
			$("#ConsultaEndosoBtn").hide();
			...
			$('#ConsultaEndosoBtn').click(function(){		
				CargarEndosoTodos();	
			});
			...
			$('#LimpiarBtn').click(function(){	
				...
				$("#gridCotizaciones").show();
	    	 	...
	    	 	$("#confirmadas").attr('checked', false);
    		...
    		$("#revocar-record").click(function(){
				var selected = "";
				var r = confirm("Seguro que desea revocar la cotización.");
	    		if (r == true) {
			       	 $("#cargando").fadeIn("slow");
			       	 tipoConsulta = "Revocar";
			       	 selected = $("#CotizacionId").val();			       	 
			    		$.ajax({
			    			...
			    			success : function(data) {
								...
								if (typeof listDetalle != 'undefined') {
									$.each(listDetalle, function(index) {
										$("#msgPopup").text("");
										$("#msgPopup").text(listDetalle[index].detalle);
										$("#msgPopup").show();
									});
	...
	function Cargar() {
		...
		var puntoVenta = $("#punto_venta_session option:selected").val() ? $("#punto_venta_session option:selected").val() : "";
		var canalId = $("#sucursal_canal option:selected").val() ? $("#sucursal_canal option:selected").val() : "";	
		...
		$("#grid").kendoGrid({
			...
			dataSource: {
                ...
                transport:{
                	read: {
                		url: "../AgriCotizacionMovimientoController",
                		data: {
                			"fInicio" : fechaInicio,
    						"fFinal" : fechaFin,
            ...
            columns: [
						{ field: "idCotizacion", title: "Id Cotización", width: "90px",headerAttributes: { style: "white-space: normal"}},
						{ field: "idEmision", title: "Poliza.", width: "90px",headerAttributes: { style: "white-space: normal"}},
						{ field: "numeroTramite", title: "Número Trámite", width: "150px",headerAttributes: { style: "white-space: normal"}},
						{ field: "estado", title: "Estado", width: "120px",headerAttributes: { style: "white-space: normal"},attributes:{style:"color: red;"}},
						{ field: "tipoSubEndoso", title: "Tipo", width: "100px",headerAttributes: { style: "white-space: normal"}},
						{ field: "anexo", title: "Anexo", width: "60px"},
						{ field: "fechaEmisionSucre", title: "Fecha de movimientos Sucre", format:"{0:dd/MM/yyyy}" ,type:"date", width: "100px",headerAttributes: { style: "white-space: normal"}},	
						{ field: "fechaNotificacionQBE", title: "Fecha Notificacion a QBE" , format:"{0:dd/MM/yyyy}" ,type:"date", width: "100px",headerAttributes: { style: "white-space: normal"}},
						{ field: "fechaVigencia", title: "Fecha de Vigencia",type:"date", format:"{0:dd/MM/yyyy}" , width: "100px",headerAttributes: { style: "white-space: normal"}},
						{ field: "identificacion", title: "Identificación Cliente", width: "90px",headerAttributes: { style: "white-space: normal"}},
						{ field: "nombresCliente", title: "Cliente", width: "160px",headerAttributes: { style: "white-space: normal"}},
						{ field: "sponsor", title: "Sponsor", width: "100px",headerAttributes: { style: "white-space: normal"}},
						{ field: "canal", title: "Canal", width: "180px",headerAttributes: { style: "white-space: normal"}},
						{ field: "fechaSiembra", title: "Fecha de Siembra", format:"{0:dd/MM/yyyy}" ,type:"date", width: "100px",headerAttributes: { style: "white-space: normal"}},
						{ field: "vigenciaDias", title: "vigenciaDias", width: "120px",headerAttributes: { style: "white-space: normal"},hidden: true, exportar: true},
						{ field: "cultivo", title: "Cultivo", width: "120px",headerAttributes: { style: "white-space: normal"}},
						{ field: "provincia", title: "Provincia", width: "120px",headerAttributes: { style: "white-space: normal"}},
						{ field: "canton", title: "Cantón", width: "100px",headerAttributes: { style: "white-space: normal"}},
						{ field: "parroquia", title: "Parroquia", width: "140px",headerAttributes: { style: "white-space: normal"}},
						{ field: "direccion_Siembra", title: "Dirección Siembra", width: "160px",headerAttributes: { style: "white-space: normal"}},
						{ field: "hectareasModificadas", title: "Hectareas Modificadas", width: "80px",headerAttributes: { style: "white-space: normal"}},
						{ field: "hectareasLote", title: "Hectareas Lote",hidden: true, exportar: true, width: "80px",headerAttributes: { style: "white-space: normal"}},
						{ field: "hectareasAsegurables", title: "Hectareas Aseguradas", width: "80px",headerAttributes: { style: "white-space: normal"}},
						{ field: "primaNeta", title: "Prima Neta Endoso", width: "80px",headerAttributes: { style: "white-space: normal"}},
						{ field: "seguroCampesino", title: "Seguro Campesino", width: "80px",headerAttributes: { style: "white-space: normal"},hidden: true, exportar: true},
						{ field: "superBancos", title: "Super Bancos", width: "80px",headerAttributes: { style: "white-space: normal"},hidden: true, exportar: true},
						{ field: "derechoEmision", title: "Derecho Emision", width: "80px",headerAttributes: { style: "white-space: normal"},hidden: true, exportar: true},
			            { field: "iva", title: "Iva", width: "70px",headerAttributes: { style: "white-space: normal"},hidden: true, exportar: true},
						{ field: "primaTotal", title: "Prima Total del Endoso", width: "70px",headerAttributes: { style: "white-space: normal"}},
						{ field: "sumaEndoso", title: "Suma Asegurada Endoso", width: "80px",headerAttributes: { style: "white-space: normal"}},
						{ field: "primaCotizacion", title: "Prima Neta Global", width: "70px",headerAttributes: { style: "white-space: normal"}},
						{ field: "primaTotalCotizacion", title: "Prima Total Global", width: "70px",headerAttributes: { style: "white-space: normal"}},
						{ field: "sumaCotizacion", title: "Suma Asegurada Global", width: "70px",headerAttributes: { style: "white-space: normal"}},						
						{ field: "estadoGeneral", title: "Estado General", width: "70px",headerAttributes: { style: "white-space: normal"}},
	...
	function CargarCotizacion() {	
		...
		$("#grid2").kendoGrid({
            ...
            columns: [
				...
				{ field: "Ciclo", title: "Periodo" , width: "100px",headerAttributes: { style: "white-space: normal"}},
				...
				{ field: "NumeroTramite", title: "Nro. Trámite", width: "140px",headerAttributes: { style: "white-space: normal"},headerAttributes: { style: "white-space: normal"}},
				{ field: "VigenciaDias", title: "Vigencia en Dias", width: "120px", hidden: true, exportar: true,headerAttributes: { style: "white-space: normal"}},
				...
				{ field: "Telefono", title: "Telefono", width: "100px", hidden: true, exportar: true,headerAttributes: { style: "white-space: normal"}},
				{ field: "hectareasAsegurables", title: "Has. Aseg", width: "50px",headerAttributes: { style: "white-space: normal"},headerAttributes: { style: "white-space: normal"}},
				{ field: "sumaAseguradaTotal", title: "Monto Asegurado", width: "70px",headerAttributes: { style: "white-space: normal"},headerAttributes: { style: "white-space: normal"}},
				...
				{ field: "iva", title: "IVA", width: "70px",headerAttributes: { style: "white-space: normal"}, hidden: true, exportar: true},
				{ field: "totalFactura", title: "Prima Total", width: "70px",headerAttributes: { style: "white-space: normal"}},                      
				...
				{ field: "Confirmacion", title: "Confirmación de Emisión del Canal", width: "120px", attributes:{style:"color: red;"}},
				{ field: "Movimiento", title: "Tiene Movimientos", width: "120px", attributes:{style:"color: red;"}},
	...
	function fnEventoClick(e) {
        ...
        $('#add').modal('show');
        actualizar(dataItem.idCotizacion);
    }
...
<div class="modal fade"  id="add" tabindex="-1" role="dialog"
				...
				<div class="modal-content">
					<form id="formCrud">
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-primary" id="revocar-record">Revocar</button>
						</div>
					</form>
				</div>
			</div>
	...
	<div class="row crud-nav-bar">
		<div class="well">
			<table class="table">
				<thead>
					<tr>
						<td colspan="6" style="font-weight: bold;" align="center">Buscador de Cotizaciones Confirmadas por los canales.</td>
					...
					<tr>
						...
						<th style="width: 300px"><input type="text"
							id="cotizacion_id" onkeypress="return justNumbers(event);" style="width: 100%"></th>
						<th style="width: 100px">Nro. Tr&aacute;mite:</th>
						<th style="width: 300px"><input type="text" id="nro_tramite" style="width: 100%"></th>
					</tr>
					<tr>
						<th style="width: 180px">Búsqueda por Fechas de notificación de Movimientos:</th>
						<th style="width: 100px">Fecha Ingreso Desde:</th>
						<th style="width: 300px"><input type="text" data-date-format="dd-mm-yyyy" id="dp1" style="width: 100%"></th>
						<th style="width: 100px">Fecha Ingreso Hasta:</th>
					...
					<tr>
						<th style="width: 180px">Busqueda de Reporte:</th>
						<th style="width: 100px">Tipo de Reporte:</th>
						<th style="width: 300px">
							<input type="radio" name="reporte" value="1" id="R_E_si" checked> Reporte Endosos Emision<br>
							<input type="radio" name="reporte" value="2" id="R_E_no"> Reporte Cotizaciones Emitidas<br>
						</th>						
					</tr>
				...
				<tbody>
					<tr>
						...
						<th>
							<button class="btn btn-primary" id="ConsultaEndosoBtn">
								<span class="glyphicon glyphicon-search"></span> &nbsp; Consulta Endosos
							</button>
						</th>												
					</tr>
				</tbody>
	...
	<!-- Table -->
	<div class="row crud-nav-bar" id="reporteEndosos">
		<div class="well">
			<div class="row">		
				<div class="table-responsive">	
					<h3>Reporte de Endosos Emisión</h3>			
					<div id="grid">
	...
	<div class="row crud-nav-bar" id="reporteCotizacion">
		<div class="well">
			<div class="row">		
				<div class="table-responsive">	
					<h3>Reporte de Cotizaciones Emitidas</h3>			
					<div id="grid2">
