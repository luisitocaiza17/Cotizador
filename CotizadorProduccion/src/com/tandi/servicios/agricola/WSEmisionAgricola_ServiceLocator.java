...
public class WSEmisionAgricola_ServiceLocator extends org.apache.axis.client.Service implements com.tandi.servicios.agricola.WSEmisionAgricola_Service {
    ...
    private java.lang.String WSEmisionAgricolaPort_address = "http://181.39.13.174:8085/ensurance/WSEmisionAgricola";
    ...
    public com.tandi.servicios.agricola.WSEmisionAgricola_PortType getWSEmisionAgricolaPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.tandi.servicios.agricola.WSEmisionAgricola_PortType getWSEmisionAgricolaPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.tandi.servicios.agricola.WSEmisionAgricolaPortBindingStub _stub = new com.tandi.servicios.agricola.WSEmisionAgricolaPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.tandi.servicios.agricola.WSEmisionAgricola_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.tandi.servicios.agricola.WSEmisionAgricolaPortBindingStub _stub = new com.tandi.servicios.agricola.WSEmisionAgricolaPortBindingStub(new java.net.URL(WSEmisionAgricolaPort_address), this);
                _stub.setPortName(getWSEmisionAgricolaPortWSDDServiceName());
                return _stub;
            }
        }
