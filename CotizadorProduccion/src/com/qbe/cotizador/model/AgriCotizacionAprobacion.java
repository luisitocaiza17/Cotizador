...
@NamedQueries({
		...
		@NamedQuery(name="AgriCotizacionAprobacion.buscarTramite", query="SELECT p FROM AgriCotizacionAprobacion p where p.NumeroTramite=:NumeroTramite"),
		@NamedQuery(name="AgriCotizacionAprobacion.buscarTramiteCoincidencia", query="SELECT p FROM AgriCotizacionAprobacion p where p.NumeroTramite like :NumeroTramite ")
})
...
//	private BigInteger UsuarioId;
	...
	@Column(name = "TIPOS_MOVIMIENTO")
	private String tiposMovimiento;
	...
	public String getTieneIndemnizacion() {
		return tieneIndemnizacion;
	}

	public void setTieneIndemnizacion(String tieneIndemnizacion) {
		this.tieneIndemnizacion = tieneIndemnizacion;
	}
	...
	public void setTiposMovimiento(String tiposMovimiento) {
