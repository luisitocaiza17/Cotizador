 ...
 */
@Entity
@Table(name="AGRI_REGLA_ORIGINAL_AUDITORIA")
@NamedQueries({
	@NamedQuery(name="AgriReglaOriginal.buscarTodos", query="SELECT a FROM AgriReglaOriginal a")
	})

public class AgriReglaOriginal {

	private static final long serialVersionUID = 1L;
	
	public AgriReglaOriginal() {
	}

	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	@Column(name="AGRI_REGLA_ORIGINAL_ID")
	private BigInteger agriReglaOriginalId;
	...
	public BigInteger getAgriReglaOriginalId() {
		return agriReglaOriginalId;
	}

	public void setAgriReglaOriginalId(BigInteger agriReglaOriginalId) {
		this.agriReglaOriginalId = agriReglaOriginalId;
	}
