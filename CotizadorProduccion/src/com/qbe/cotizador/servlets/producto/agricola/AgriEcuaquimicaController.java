...
/**
 * Servlet implementation class AgriEcuaquimicaController
 */
@WebServlet("/AgriEcuaquimicaController")
public class AgriEcuaquimicaController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AgriEcuaquimicaController() {
        super();
	...
	public static JSONArray procesarCotizacionesCargaPrevia(
		...
		try {
			...
			for (CotizacionArchivoPlano nuevaCotizacion : listadoLimpio) {
				...
				String DatosRecibidos = " ARCHIVO PLANO ECUAQUIMICA: Canal: "+nuevaCotizacion.getCanal()
				...
				try {
					...
					PPuntoVenta = PPuntoVentaProceso.buscarCodigoIntegracion("ECUAQUIMICA");
					...
					if (puntoVenta != null)
						...
						throw new Exception("El canal ECUAQUIMICA no existe");
					}
					...
					agriObjetoCotizacion.setTipoOrigen("ECUAQUIMICA");
