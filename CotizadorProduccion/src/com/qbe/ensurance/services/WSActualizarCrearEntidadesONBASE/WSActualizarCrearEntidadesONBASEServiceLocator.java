...
public class WSActualizarCrearEntidadesONBASEServiceLocator extends org.apache.axis.client.Service implements com.qbe.ensurance.services.WSActualizarCrearEntidadesONBASE.WSActualizarCrearEntidadesONBASEService {
 ...
 // Use to get a proxy class 
    ...
    public com.qbe.ensurance.services.WSActualizarCrearEntidadesONBASE.WSActualizarCrearEntidadesONBASE getWSActualizarCrearEntidadesONBASE() throws javax.xml.rpc.ServiceException {
    ...
    public com.qbe.ensurance.services.WSActualizarCrearEntidadesONBASE.WSActualizarCrearEntidadesONBASE getWSActualizarCrearEntidadesONBASE(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.qbe.ensurance.services.WSActualizarCrearEntidadesONBASE.WSActualizarCrearEntidadesONBASESoapBindingStub _stub = new com.qbe.ensurance.services.WSActualizarCrearEntidadesONBASE.WSActualizarCrearEntidadesONBASESoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.qbe.ensurance.services.WSActualizarCrearEntidadesONBASE.WSActualizarCrearEntidadesONBASE.class.isAssignableFrom(serviceEndpointInterface)) {
                com.qbe.ensurance.services.WSActualizarCrearEntidadesONBASE.WSActualizarCrearEntidadesONBASESoapBindingStub _stub = new com.qbe.ensurance.services.WSActualizarCrearEntidadesONBASE.WSActualizarCrearEntidadesONBASESoapBindingStub(new java.net.URL(WSActualizarCrearEntidadesONBASE_address), this);
                _stub.setPortName(getWSActualizarCrearEntidadesONBASEWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://10.10.10.177:8085/ensurance/services/WSActualizarCrearEntidadesONBASE", "WSActualizarCrearEntidadesONBASEService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://10.10.10.177:8085/ensurance/services/WSActualizarCrearEntidadesONBASE", "WSActualizarCrearEntidadesONBASE"));
        }
