...
public class PQBE_wsACTUALIZAESTADOResponse  implements java.io.Serializable {
    private sucreagrop.SdtResponseQBE respuesta;

    public PQBE_wsACTUALIZAESTADOResponse() {
    }

    public PQBE_wsACTUALIZAESTADOResponse(
           sucreagrop.SdtResponseQBE respuesta) {
     ...
     * @return respuesta
     */
    public sucreagrop.SdtResponseQBE getRespuesta() {
        return respuesta;
    }
     ...
     * @param respuesta
     */
    public void setRespuesta(sucreagrop.SdtResponseQBE respuesta) {
        this.respuesta = respuesta;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("sucreagrop", ">pQBE_ws.ACTUALIZAESTADOResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("respuesta");
        elemField.setXmlName(new javax.xml.namespace.QName("sucreagrop", "Respuesta"));
        elemField.setXmlType(new javax.xml.namespace.QName("sucreagrop", "sdtResponseQBE"));
