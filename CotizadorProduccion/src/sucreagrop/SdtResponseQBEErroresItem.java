...
public class SdtResponseQBEErroresItem  implements java.io.Serializable {
    private sucreagrop.ErrorUN01 error;

    public SdtResponseQBEErroresItem() {
    }

    public SdtResponseQBEErroresItem(
           sucreagrop.ErrorUN01 error) {
           this.error = error;
    }
     ...
     * @return error
     */
    public sucreagrop.ErrorUN01 getError() {
        return error;
    }
     ...
     * @param error
     */
    public void setError(sucreagrop.ErrorUN01 error) {
        this.error = error;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("sucreagrop", "sdtResponseQBE.ErroresItem"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("error");
        elemField.setXmlName(new javax.xml.namespace.QName("sucreagrop", "Error"));
        elemField.setXmlType(new javax.xml.namespace.QName("sucreagrop", "ErrorUN01"));
