...
public class PQBE_wsLocator extends org.apache.axis.client.Service implements SucreAgro7.PQBE_ws {
    ...
    private java.lang.String pQBE_wsSoapPort_address = "http://181.198.93.61:8080/sucreagro/servlet/apqbe_ws?wsdl";
    ...
    public SucreAgro7.PQBE_wsSoapPort getpQBE_wsSoapPort() throws javax.xml.rpc.ServiceException {
    ...
    public SucreAgro7.PQBE_wsSoapPort getpQBE_wsSoapPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            SucreAgro7.PQBE_wsSoapBindingStub _stub = new SucreAgro7.PQBE_wsSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (SucreAgro7.PQBE_wsSoapPort.class.isAssignableFrom(serviceEndpointInterface)) {
                SucreAgro7.PQBE_wsSoapBindingStub _stub = new SucreAgro7.PQBE_wsSoapBindingStub(new java.net.URL(pQBE_wsSoapPort_address), this);
                _stub.setPortName(getpQBE_wsSoapPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("SucreAgro7", "pQBE_ws");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("SucreAgro7", "pQBE_wsSoapPort"));
        }
