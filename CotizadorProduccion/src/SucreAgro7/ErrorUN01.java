...
public class ErrorUN01  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("SucreAgro7", "ErrorUN01"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("SucreAgro7", "ErrorB"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("SucreAgro7", "item"));
        typeDesc.addFieldDesc(elemField);
    }
