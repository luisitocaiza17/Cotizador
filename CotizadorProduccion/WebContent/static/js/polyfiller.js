! function(a) {
    ...
    }, window.webshim = window.webshims, window.webshims.timer = setInterval(c, 0), c(), "function" == typeof define && define.amd && define.amd.jQuery && define("polyfiller", ["jquery"], a)
}(function(a) {
    "use strict";
    var b, c, d = window.webshims,
        e = "dom-support",
        f = a.event.special,
        g = a([]),
        h = window.Modernizr,
        i = window.asyncWebshims,
        j = h.addTest,
        k = window.Object,
        l = function(a) {
            return a + "\n//# sourceURL=" + this.url
        };
    h.advancedObjectProperties = h.objectAccessor = h.ES5 = !!("create" in k && "seal" in k), !h.ES5 || "toJSON" in Date.prototype || (h.ES5 = !1), clearInterval(d.timer), c = a.support.hrefNormalized === !1 ? d._curScript.getAttribute("src", 4) : d._curScript.src, c = c.split("?")[0].slice(0, c.lastIndexOf("/") + 1) + "shims/", a.extend(d, {
        version: "1.12.4",
        cfg: {
            waitReady: !0,
            loadStyles: !0,
        ...
        addPolyfill: function(b, c) {
            ...
            }), n[e].failedM && (c.test = !0), n[e].push(b), c.options = a.extend(m[e], c.options), u(b, c), c.methodNames && a.each(c.methodNames, function(a, b) {
                d.addMethodName(b)
            })
        },
        polyfill: function() {
            return function(a) {
                a || (a = d.featureList), "string" == typeof a && (a = a.split(" "));
                return d._polyfill(a)
            }
        }(),
        _polyfill: function(c) {
            var d = [];
            b(), -1 == a.inArray("forms", c) && -1 !== a.inArray("forms-ext", c) && c.push("forms"), m.waitReady && (a.readyWait++, p(c, function() {
                a.ready(!0)
        ...
        reTest: function() {
            var b, c = function(c, d) {
                var e, g = r[d],
                    h = d + "Ready";
                !g || g.loaded || (g.test && a.isFunction(g.test) ? g.test([]) : g.test) || (f[h] && delete f[h], e = n[g.f], b.push(d))
            };
            return function(d) {
        ...
        capturingEvents: function(b, c) {
            document.addEventListener && ("string" == typeof b && (b = [b]), a.each(b, function(b, e) {
                var g = function(b) {
                    return b = a.event.fix(b), c && d.capturingEventPrevented && d.capturingEventPrevented(b), a.event.dispatch.call(this, b)
                };
            ...
            loadList: function() {
                var b = [],
                    ...
                    e = function(c, d) {
                        ...
                        return f ? (e = f.test && a.isFunction(f.test) ? f.test(d) : f.test, e ? (o(c, !0), !0) : !1) : !0
                    },
                    f = function(b, c) {
                        if (b.d && b.d.length) {
                            var d = function(b, d) {
                ...
                return function(g) {
                    ...
                    for (i = 0; i < g.length; i++) h = r[g[i]], h && !e(h.name, g) && (h.css && m.loadStyles && s.loadCSS(h.css), h.loadInit && h.loadInit(), f(h, g), h.loaded || l.push(h.name), h.loaded = !0);
                    for (i = 0, j = l.length; j > i; i++) k = !1, h = l[i], -1 == a.inArray(h, b) && ("noCombo" != m.debug && a.each(r[h].c, n), k || c(r[h].src || h, h))
                }
            }(),
            makePath: function(a) {
                return -1 != a.indexOf("//") || 0 === a.indexOf("/") ? a : (-1 == a.indexOf(".") && (a += ".js"), m.addCacheBuster && (a += m.addCacheBuster), m.basePath + a)
            },
            loadCSS: function() {
                var b, c = {};
                return function(d) {
    ...
    return d.addMethodName = function(b) {
        ...
        function() {
            ...
            b = function() {
                if (!b.run) {
                    if ((m.debug || !("crossDomain" in m.ajax) && location.protocol.indexOf("http")) && (m.ajax.crossDomain = !0), a.mobile && (a.mobile.textinput || a.mobile.rangeslider || a.mobile.button) && (m.readyEvt || (m.readyEvt = "pageinit"), m.waitReady = !1), !a.isDOMReady && m.waitReady) {
                        var d = a.ready;
                        a.ready = function(b) {
            ...
            a.extend(d, {
                ...
                a.fn[c.replace(/[A-Z]/, function(a) {
                    ...
                    return a.fn[c].apply(this, arguments), a.isDOMReady && d.triggerDomUpdate(this), this
                }
        ...
        function() {
            var b = "defineProperty",
                ...
                g = function(a) {
                    if (a)
                        for (var b in a) c.call(a, b) && f(a[b])
                };
        ...
        function() {
            var b, c, f, g = "form-shim-extend",
                i = h.input,
                k = h.inputtypes,
                l = "formvalidation",
                n = "form-number-date-api",
                o = !1,
                p = !1,
                s = function() {
                    var c, d;
                    if (!s.run) {
                        if (d = a('<fieldset><textarea required="" /></fieldset>')[0], j(l, !(!i.required || !i.pattern)), j("fieldsetelements", c = "elements" in d), "disabled" in d) {
                            if (!c) try {
                                a("textarea", d).is(":invalid") && (d.disabled = !0, c = a("textarea", d).is(":valid"))
                            } catch (e) {}
                            j("fieldsetdisabled", c)
                        }
                        h[l] ? (p = !(h.fieldsetdisabled && h.fieldsetelements && "value" in document.createElement("progress") && "value" in document.createElement("output")), v.bustedValidity = o = window.opera || v.bustedValidity || p || !i.list) : v.bustedValidity = !1, b = h[l] && !o ? "form-native-extend" : g
                    }
                    return s.run = !0, !1
                };
            document.createElement("datalist"), d.validationMessages = d.validityMessages = {
                ...
                test: function() {
                    var a = this.options;
                    return s(), p && !a.replaceUI && /Android/i.test(navigator.userAgent) && (a.replaceUI = !0), !a.replaceUI && r[n].test()
                },
        ...
        function() {
            d.mediaelement = {}, j({
                ...
                test: function() {
                    var a = this.options;
                    return h.audio && h.video && !d.mediaelement.loadSwf ? (a.preferFlash && !r.swfmini.test() && (a.preferFlash = !1), !(a.preferFlash && swfmini.hasFlashPlayerVersion("10.0.3"))) : !1
                },
                c: [21, 19, 25, 20]
            }), v.track = !window.TextTrackCue || !h.texttrackapi, q("track", {
                options: {
                    positionDisplay: !0,
                    override: v.track
                },
            ...
            }), i && (i.cfg && (i.cfg.length || (i.cfg = [
                [i.cfg]
            ]), a.each(i.cfg, function(a, b) {
                d.setOptions.apply(d, b)
            })), i.ready && a.each(i.ready, function(a, b) {
                d.ready.apply(d, b)
            }), i.lang && d.activeLang(i.lang), "polyfill" in i && d.polyfill(i.polyfill)), d.isReady("jquery", !0)
        }, d.callAsync(), d
});