...
<!-- KENDO -->
<link rel="stylesheet" href="../static/css/Kendo/kendo.mobile.all.min.css" />
<link rel="stylesheet" href="../static/css/Kendo/kendo.common.min.css" />
<link rel="stylesheet" href="../static/css/Kendo/kendo.blueopal.min.css" />
<script src="../static/js/Kendo/kendo.all.min.js"></script>
<script src="../static/js/Kendo/kendo.web.min.js"></script>
<link rel="stylesheet" href="../static/font-awesome/css/font-awesome.min.css">
<script id="tipoObjetoCargaInicial" src="../static/js/pymes/carga.inicial.cotizador.pymes.cerrados.js" tipoObjetoValor="PYMES"></script>
<script id="tipoObjetoMetodos" src="../static/js/pymes/metodos.pymes.cerrados.js" tipoObjetoValor="PYMES"></script>
...
<script>
	...
	var actividadEconomicaList = "";
	var tipoPredioList = "";
	$(document).ready(function() {
		activarMenu("CotizacionPymes");
		cargar();
...
<body>
	...
	*      I N I C I O   D E   L A   V E N T A N A    M O D A L   R E S U M E N
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form id="formCrudResumen">
					...
					<div class="form-group">
						<table class="table table-bordered table-hover">
							...
							<tr>
								...
								<td><input id="resumen_valor_compensacion" disabled="disabled" type="text" style="text-align: right;"></input></td>
							</tr>
							<tr>
					...
					<div>
										El valor cotizado puede ser sujeto a variación al momento de la facturación de acuerdo a la 
										DISPOSICIÓN TRANSITORIA PRIMERA DE LA LEY ORGÁNICA DE SOLIDARIDAD Y DE CORRESPONSABILIDAD CIUDADANA PARA 
										LA RECONSTRUCCIÓN Y REACTIVACIÓN DE LAS ZONAS AFECTADAS POR EL TERREMOTO DE 16 DE ABRIL DE 2016 publicada 
										en el registro oficial Suplemento 759 del día 20 de mayo del 2016. 
									</div>
									<br/>
									<br/>
				</form>
	...
	<!-- Modal -->
	<div class="modal fade" id="add" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static"
		aria-labelledby="myModalLabel" aria-hidden="true">
				...
				<!--<form id="formCrud">-->
							...
							<div id="tabstrip">
											...
											<table style="width: 100%">
												<tr>
													...
													<td colspan="5"><select name="actividad_economica"
														id="actividad_economica" data-placeholder="Seleccione una opción..." required="required"
												...
												<tr>
													...
													<td colspan="5"><select name="giro_negocio"
														id="giro_negocio" required="required" data-placeholder="Seleccione una opción..."
														class="datosPymes"></select></td>
												</tr>
												<tr>
													<td>&nbsp;</td>
												...
												<tr>
													...
													<td><input type="text"
														...
														id="ubicacion_nombre_edificio"
														class="datosPymes"></input></td>
													<td>No. Oficina/Piso:</td>
													<td><input type="text" name="ubicacion_numero_oficina"
														id="ubicacion_numero_oficina"
														class="datosPymes"></input></td>
												</tr>
												<tr>
													<td>&nbsp;</td>
												</tr>
												<!-- <tr id="fila_constitucion">
												...
												<tr>
													<td>Seguridad Adecuada:</td>
													<td colspan="5">Si<input type="radio"
														id="seguridad_adecuada_si" class="datosPymes"
														name="seguridad_adecuada"></input>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; No <input type="radio"
														id="seguridad_adecuada_no" class="datosPymes"
														name="seguridad_adecuada"></input>
													</td>
												</tr> 
										<tr>
											<td colspan="1">Requiere Inspección:</td>
											<td align="rigth">Si<input type="radio"
												...
												<tr>
													<td>
													<input type="hidden"
													id="tiene_mas_dos_anios" name = "tiene_mas_dos_anios" value="1"
													class="datosPymes">
													
													</input>
													<input type="hidden"
													id="contabilidad_formal" name ="contabilidad_formal" value="1"
													class="datosPymes">
													</input>
													&nbsp;</td>
												</tr>
								...
								<div class="tab_strip_direccion" align="center">
									<table style="width: 200%" >
										...
										<!-- CONTROLES CAMBIOS DE TASAS EN CASO DE PERTENECER A LUGARES CON RIESGOS -->
										<!-- ponemos un control el cual se cargara con 0 si no tiene riesgo y 1 si tiene riesgo -->
										<input type="hidden" id="tieneRiesgo"></input>
										<tr id="riesgoDanioColumn">										
											<td>¿El riesgo sufrió daño en el terremoto?</td>																						
											<td colspan="5">Si<input type="radio" checked="checked"
												id="riesgoDanio_si" class="datosPymes"
												name="riesgoDanio"></input>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; No <input type="radio"
												id="riesgoDanio_no" class="datosPymes"
												name="riesgoDanio"></input>																																				
											</td>																																																							
										</tr>																																								
										<tr id="riesgoVolcanColumn">
											<td>¿a Cuánto metros se encuentra de la zona de riesgo?</td>
											<td colspan="5"><input type="text"
												id="distanciaRiesgo" class="datosPymes"
												name="distanciaRiesgo" onchange="calcularTotalValorAsegurado();">
											</td>											
										</tr>	
										<tr>
											<td>&nbsp;</td>
										...
										<tr>
											 <!--  td style="width: 10%"><label><b>Estructura:*</b></label></td>-->
												<td ><select
													id="planes_estructuras" required="required"
													class="datosPymes">
													</select></td> 
												<td style="width: 25%"><input type="hidden"
													id="valor_estructura" value=""
													class="datosPymes">
													</input></td>	
										</tr>
										<tr>
													<td  style="width: 10%">
													<button class="btn btn-success" style="font-size:18px;  color:white">Estructura: <i class="fa fa-building" style="font-size:36px;color:white"></i></button>
													</td>
												    <td nowrap="off" style="width: 100%">
												    <div id="selectEstructura" class="btn-group alignment Estructura"  data-toggle-name="selectEstructura" data-toggle="buttons-checkbox">
        										    </div>
        										    <input id="codigoEstructura" type="hidden" name="selectEstructura" value="0">
        										    </td>
										</tr>
										<tr>
											<td>&nbsp;</td>
										...
										<tr>
											<!--  <td style="width: 10%"><label><b>Contenidos:*</b></label></td>-->
												<td ><select
													id="planes_contenidos" required="required"
													class="datosPymes"></select></td>
												<td ><input type="hidden"
													id="valor_contenidos" value=""
													class="datosPymes">
													</input></td>	
										</tr>										
										<tr>
											<td>
											<button class="btn btn-danger" style="font-size:18px; color:white">Contenido: <i class="fa fa-unlock-alt" style="font-size:36px;color:white"></i></button>
											</td>
										    <td style="width: 100%">
										    <div id="selectContenido" class="btn-group alignment Contenido" data-toggle-name="selectContenido" data-toggle="buttons-checkbox">
      										    </div>
      										    <input id="codigoContenido" type="hidden" name="selectContenido" value="0">
      										    </td>
										<tr>
											<td>&nbsp;</td>
										</tr>
										...
										<tr>
											<td colspan="4" style="color: #FF0000; font-size: x-small;">
											<label id="advertencia_general"></label>
											</td>
									...
									<table>
										<tr>
											<td style="width: 40%; vertical-align: top;">
												...
												<table style="width: 100%">
													<tr>
														<td>
															<div style="height: 330px; overflow-y: scroll;">
																<table id="coberturas_por_direccionEstructuras" style="width: 100%">
																		<legend id = "tituloEstructuras" >Estructuras</legend>
																</table>
															</div>
														</td>
													</tr>
													...
													<tr>	
														<td>
															<div style="height: 330px; overflow-y: scroll;">
																<table id="coberturas_por_direccionContenidos" style="width: 100%">
																	<legend id = "tituloContenidos" >Contenidos</legend>
																</table>
															</div>
														</td>
													</tr>
											...
											<td style="width: 60%; vertical-align: top;">
												<div style="height: 330px; overflow-y: scroll;">													
														<table id="detalle_cobertura_direccionEstructuras">
														</table>
														<table id="detalle_cobertura_direccionContenidos">
														</table>
										...
										<tr>
											<td style="width: 40%; vertical-align: top;">
												...
												<table style="width: 100%">
													<tr>
														<td>
															<table id="deducibles_por_direccion" style="width: 100%">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary" id="guardar"
							onclick="grabarDireccion()">Guardar</button>
					</div>
				<!-- </form> -->
			</div>
		</div>
		...
		<form id="wizard">
							...
							<table>
								<tr>
									...
									<td style="width: 35%"><select
										...
										id="tipo_identificacion_principal" required="required"></select>
										<br/>
										<label id="lbles_contribuyente" style="display:none;"><b>Contribuyente Especial:</b></label>
								...
								<tr>
									...
									<td style="width: 35%"><input type="text" id="celular" minlength="10" title="El celular esta compuesto de 10 numeros."
			...
			<section>
            	...
            	************************************************************************************************-->
				...
				<div id="tabstrip_coberturas_generales">
					<ul id="tab_coberturas_generales" class="nav nav-tabs"	data-tabs="tabs">
						<li class="active"><a href="#tab_asistencias" data-toggle="tab">Asistencia PYMES</a></li> 
						<li><a href="#tab_coberturasgenerales" data-toggle="tab">Ramos Adicionales</a></li>
					...
					<div style="width: 100%">
						<div class="thumbnail" style="padding: 20px;">
							<table id="inspeccion_tabla_detalle_pagos"
								...
								<tr>
									<td style="text-align: right">Compensaci&oacute;n del IVA <span class="valor_compensacion"></span>%</td>
									<td><input id="inspeccion_valor_compensacion" disabled="disabled" type="text" style="text-align: right;"></input></td>
								</tr>
								<tr>
									<td style="text-align: right">TOTAL :</td>
						...
						<tr>
							<td style="text-align: center">
								<button type="button" id="registrarParaInspeccion"
									...
									<span class='glyphicon glyphicon glyphicon-check'></span>Registrar
									Inspección
								</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<button type="button" id="procesarReporteBorrador"
									class='btn btn-success btn-xs'>
									<span class='glyphicon glyphicon glyphicon-check'></span>Reporte
									Borrador de la Póliza
								</button>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<button type="button" id="enviarReporte"
									class='btn btn-success btn-xs'>
									<span class='glyphicon glyphicon glyphicon-check'></span>Enviar Cotización por Email
								</button>
							</td>
						</tr>
					</table>
			...
			<section>
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<div class="alert alert-danger" id="msgPopupFichaPagoError" hidden>
							<button type="button" class="close"
								onclick="cerrarAlertFichaInspeccionError()">
								<span aria-hidden="true">&times;</span><span class="sr-only">Close</span>
							</button>
							<label id="lblContenidoMensajePago"></label>
						</div>
						...
						<div id="tabbable" class="tabbable">
							...
							<div class="tab-content">
										...
										<div style="width: 80%">
											<div class="thumbnail" style="padding: 20px;">
												<table id="tabla_detalle_pagos" style="width: 100%"
													...
													<tr>
														<td style="text-align: right">IVA <span class="valor_iva"></span>%</td>
														<td><input id="iva" disabled="disabled" type="text" style="text-align: right;"></input></td>
													</tr>
													<tr>
														<td style="text-align: right">Compensaci&oacute;n del IVA <span class="valor_compensacion"></span>%</td>
														<td><input id="valor_compensacion" disabled="disabled" type="text" style="text-align: right;"></input></td>
													</tr>
													<tr>
														<td style="text-align: right">TOTAL :</td>
								...
								<div class="tab-pane" id="tercero">
									...
									<input id="contador_endosos_beneficiario" type="hidden" value="1">
									<div class="panel panel-primary">
										<div class="panel-heading">Datos del Beneficiario</div>
										<div id="divEndosoBeneficiario" class="panel-body">
											<button type="button" id="btnAgregarDireccion" onClick="nuevoBeneficiario();"
												class="btn btn-primary btn-xs datosPymes datosPymesPosterior">
												<span class="glyphicon glyphicon glyphicon-plus"></span>
												Agregar Nuevo Endoso
											</button>
											<br/>
											<table id="fila_endoso_benficiario_1" class='table table-bordered table-hover'>
												<tr>
													<td>Beneficiario</td>
													<td><select style="width: 90%"
														id="beneficiario_1" class="datosPymes datosPymesPosterior"></select>
														<input id="endoso_beneficiario_id_1" type="hidden">
													</td>
												</tr>
												<tr>
													<td>Rubro</td>
													<td><select id="beneficiario_rubro_1" class="datosPymes datosPymesPosterior" style="width: 250px">
												...
												<tr>
													...
													<td><input type="number" value='0' min='0'
														id="valor_endoso_beneficiario_1" class="datosPymes datosPymesPosterior"></td>
												</tr>
												<tr>
													<td>
														<div align="center">
															<button type="button" class="btn btn-primary"
																id="guardar_beneficiario_1"
																onClick="guardarBeneficiario(1,1);">Guardar</button>
														</div>
													</td>
													<td>
														<div align="center">
															<button type="button" class="btn btn-danger"
																id="eliminar_beneficiario_1"
																onClick="guardarBeneficiario(2,1);">Eliminar</button>
														</div>
													</td>
												</tr>
											</table>
			...
			<section>
				...
				<div class="alert alert-success" id="msgPopupEmisionConError"
					style="display: none;">
					<button type="button" class="close" data-dismiss="alert">
						<span aria-hidden="true">&times;</span><span class="sr-only">Close</span>
					</button>
					<label id="lbl_ErrorEmisionPoliza"></label>
				</div>
				...
				<div class="panel panel-primary" id="datosFinales">
					...
					<div class="panel-body">
						...
						<table id="tablaFinalVehiculos">
							<tr>
								<button type="button" id="imprimirAutorizacionDebito" hidden="hidden"
									class='btn btn-success btn-xs'>
									<span class='glyphicon glyphicon glyphicon-check'></span>Imprimir Autorización de Debito
								</button>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<button type="button" id="imprimirVinculacionCliente" hidden="hidden"
									class='btn btn-success btn-xs'>
									<span class='glyphicon glyphicon glyphicon-check'></span>Imprimir Vinculación de Cliente
								</button>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<button type="button" id="enviarPoliza" hidden="hidden"
									class='btn btn-success btn-xs'>
									<span class='glyphicon glyphicon glyphicon-check'></span>Enviar Poliza
								</button>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<button type="button" id="imprimirPoliza" hidden="hidden"
									class='btn btn-success btn-xs'>
									<span class='glyphicon glyphicon glyphicon-check'></span>Imprimir Poliza
								</button>
							</tr>
						</table>
