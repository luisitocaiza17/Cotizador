...
<title>Producto Grupo - CotizadorQBE</title>
...
<script>
	...
	$(document)
			.ready(
					function() {
						activarMenu("ProductoGrupo");

						$
								.ajax({
									url : '../ProductoGrupoController',
									data : {
									...
									success : function(data) {
										...
										if (data.numRegistros > 0) {
											var listadoProductoGrupo = data.listadoProductoGrupo;
											$
													.each(
															listadoProductoGrupo,
															function(index) {
																$(
																		"#dataTableContent")
																		.append(
																				"	<tr class='odd gradeX'>"
																						+ " <td relation='nombre'>"
																						+ listadoProductoGrupo[index].nombre
																						+ "</td>"+
																						" <td width='175px'>" +
																						" <input type='hidden'  value='"+ listadoProductoGrupo[index].codigo +"'/>" +
											...
											$(".eliminar-btn")
													.bind(
															{
																click : function() {
																	var r = confirm("Seguro que desea eliminar el Cargo "
																			+ $(
																					this)
																					.parent()
																					.parent()
											...
											$("#dataTableContent")
													.append(
															"<tr><td colspan='2'>No existen Registros</td></tr>");
										}
									}
								});
				...
				<div class="modal-content">
					<form id="formCrud">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModalLabel">Nuevo Producto Grupo</h4>
						</div>
						<div class="modal-body">
							<div class="alert alert-success" id="msgPopup">El Producto Grupo se
								grabo con exito.</div>
							<div class="form-group">
								<input type="hidden" class="form-control" id="codigo"> <label>Nombre</label>
