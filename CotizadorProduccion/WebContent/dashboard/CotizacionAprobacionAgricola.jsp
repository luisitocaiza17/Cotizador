...
<head>
	...
	<title>Aprobacion Cotizaciones Agrícolas- CotizadorQBE</title>
...
function GetQueryStringByParameter(name) {
	...
	$(document).ready(function() {
			...
			//Boton Carga Masiva
			$('#btnRechazosMasiva').click(function(){
				
				ProcesoMasivo="rechazo";
		...
		$("#aprobar-record").bind({
			click : function() {
				...
				if (Recalculo==true){
					...
					EnviarAprobacion(cotizacionId,"","","","","","","","",observacion,false);
				}
				//cerrar ventana 
	...
	///Boton rechazar 
		$("#rechazar-record").bind({
			click : function() {
				...
				var observacion = $("#Comentario").val();
				RechazarCotizacion(cotizacion,observacion);
			}
		});
	});
 ...
 */
	...
	function CalculoValores() {
		...
		var TotalFactura = Prima + valorBase+Iva;
	...
	function RechazarCotizacion(Cotizacion,observacion) {
				...
				<tbody>
					...
					<th>
						...
						<th>
							...
							<button  class="btn btn-primary" id="btnRechazosMasiva" >Rechazos Masivos</button>
						</th>
						<th>
