						...
						<div class="panel-body">
							<table>
								...
								<tr>
									...
									<td style="width: 35%"><input type="email" id="email" class="datosGanadero" name="email" required="required"></td>
									<td style="width: 15%"><label><b>No. Teléfono:</b></label></td>
									<td style="width: 35%"><input type="text" id="telefono" class="datosGanadero" name="telefono" maxlength="9" onkeypress="return justNumbers(event);"></td>
								</tr>
								<tr>
									<td style="width: 15%"><label><b>No. Celular:*</b></label></td>
									<td style="width: 35%"><input type="text" id="celular" class="datosGanadero" name="celular" required="required"  maxlength="10" onkeypress="return justNumbers(event);"></td>
								</tr>
							</table>
						</div>
					</div>
					...
					<div class="panel-body">
						<table>
							<tr>
								...
								<td>
									<input type="date" id="fecha_credito" class="datosGanadero">
								</td>
								<td>
									<b>Monto del crédito: </b>
								</td>
								<td>
									<input type="number" value='0' min='0' id="monto_credito" class="datosGanadero" style="width: 150px" onkeypress="return justNumbers(event);">
								</td>
							</tr>
							<tr>
								<td>
					...
					<div class="panel-body">
						<table style="width: 100%">
							...
							<tr>
								...
								<td>
									<input type="number" min='1' id="hectareas_lote" style="width: 150px" class="datosGanadero" required="required" onkeypress="return justNumbers(event);">
								</td>
								<td>
							...
							<tr>
								...
								<td><input type="number" min='0' max='6000' id="ubicacion_altitud" class="datosGanadero" required="required" onkeypress="return justNumbers(event);"></td>
											...
											<div class="thumbnail" style="padding: 20px;">
												<table id="tabla_detalle_pagos" class="table table-bordered table-hover">
													...
													<tr>
														...
														<td colspan="4"><input id="total_suma_asegurada"
													...
													<tr>
														<p>El valor cotizado puede ser sujeto a variación al momento de la facturación de acuerdo a la DISPOSICIÓN TRANSITORIA PRIMERA DE LA LEY ORGÁNICA DE SOLIDARIDAD Y DE CORRESPONSABILIDAD CIUDADANA PARA LA RECONSTRUCCIÓN Y REACTIVACIÓN DE LAS ZONAS AFECTADAS POR EL TERREMOTO DE 16 DE ABRIL DE 2016 publicada en el registro oficial Suplemento 759 del día 20 de mayo del 2016.</p> 
													</tr>
									...
									<table style="width: 300px;" align="center">
										<tr>
											...
											<td><select id="cboFpFormaPago" name="cboFpFormaPago" class="datosGanadero"
												onchange="cambioFormaPago(this.value);" style="width: 150px" required="required">
											</select></td>
										</tr>
			...
			<h2>Datos Factura<i class="fa fa-edit fa-2x"></i></h2>
				...
				******************************************************************************************************************-->
			             ...
			             <fieldset class="border">
							...
							<div class="panel panel-primary" id="ubicacionPersonaNatural" style="visibility: hidden;">
								...
								<div class="panel-body">		
										<table>
										  <tr>
										    ...
										    <td colspan="3"><input type="text" id="referencia_direccion_natural" class="datosGanadero" name="referencia_direccion_natural" required="required"></td>
										  </tr>
											<tr>
							...
							<div class="panel panel-primary" id="ubicacionPersonaJuridica" style="visibility: hidden;">
							...
							<div class="panel panel-primary" id="datosPoliticaNatural" style="visibility: hidden;">
							...
							<div class="panel panel-primary" id="datosPoliticaJuridica" style="visibility: hidden;">
						     <div class="panel-heading">Actividad Politica</div>
								<div class="panel-body">
								<table>
								  <tr>
							...
							<div  class="panel panel-primary" id="situacionFinancieraNatural" style="visibility: hidden;">
							...
							<div class="panel panel-primary" id="situacionFinancieraJuridica" style="visibility: hidden;">
						     <div class="panel-heading">Situacion Financiera: Total de activos y pasivos</div>
								<div class="panel-body">
								<table>
								  <tr>
						...
						<table id="tablaResultado">
							<tr>
								...
								<td><br> <br>
									...
									<button id="btnGenerarPoliza" class="btn btn-primary"
										onclick="generarReporteCotizacion()">Generar Reporte</button>
									<br> <br>
								</td>
							</tr>
						</table>
