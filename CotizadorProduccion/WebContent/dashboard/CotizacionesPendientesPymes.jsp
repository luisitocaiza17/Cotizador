	 						...
	 						$('#dataTable').dataTable( {	 							
        						...
        						"fnDrawCallback": function( oSettings ) {
        							$(".actualizar-btn").bind({click: function(event) {
                                        ...
                                        if(tipo=="Cerrado")
                                              window.location.href='CotizacionPymesCerrados.jsp?id='+id;
                                        else
                                              window.location.href='CotizacionPymes.jsp?id='+id;
					
        								}
        								});
        							$(".eliminar-btn").bind({click: function(event) {
	        								var r = confirm("Esta seguro que desea eliminar la cotización seleccionada.?");
	    									if (r == true){
		        								var id=$(this).parent().parent().children().first().text();
