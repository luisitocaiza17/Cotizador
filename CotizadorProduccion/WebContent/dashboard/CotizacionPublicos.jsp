...
<head>
	...
	<script id="tipoObjetoCargaInicial" src="../static/js/vehiculos/carga.inicial.js" tipoObjetoValor="Publicos"></script>
	<script id="tipoObjetoMetodos" src="../static/js/vehiculos/metodos.js" tipoObjetoValor="Publicos"></script>
	...
	<body>
			...
			// Permitimos el acceso si la session existe		
				if(session.getAttribute("login") == null){
					...
					// Valor del IVA segun la url
					String cotizacionId = request.getParameter("id");
					VariableSistemaDAO variableSistemaDAO = new VariableSistemaDAO();					
					if(cotizacionId==null){
						valorIva = variableSistemaDAO.obtenerIVASegegunCotizacion(""); // IVA actual	
					}else{
						valorIva = variableSistemaDAO.obtenerIVASegegunCotizacion(cotizacionId); // IVA aplicado a la cotizacion
					}
				}
			%>
        <!--[if lt IE 7]>
	...
	<div class="content">
		...
		<form id="wizard" action="" method="post">
			...
			<h2> Productos <i class="fa fa-taxi fa-2x"></i></h2>
			<section>
			<!--***********************************************************************************************
