...
<head>
	...
	<script id="tipoObjetoCargaInicial" src="../static/js/vehiculos/carga.inicial.js" tipoObjetoValor="Livianos"></script>
	<script id="tipoObjetoMetodos" src="../static/js/vehiculos/metodos.js" tipoObjetoValor="Livianos"></script>
		        ...
		        ****************************************************************************************************************************-->
				<fieldset class="border">
						...
						<div class="panel-body">
							<table>
								...
								<tr>
									...
									<td style="width: 35%"><input type="text" name="tasa" id="tasa" disabled="disabled"><select name="tasas" id="tasas" style="display: none;" onchange="metodoValidacionTasas(this.value);"></select></td>
						...
						<div class="panel-body">
							<table>
								...
								<tr>
									...
									<td style="width: 85%" colspan="3"><input type="select"  style="width:90%" name="agentes" id="agentes" class="datosVehiculo" onchange="obtenerAgenteComision();" required="required"></td>
								</tr>
								<tr >
							    <td ><label><b>Comisi&oacute;n del agente (%):*</b></label></td>
							    <td><input type="text" id="porc_comision" name="porc_comision" readonly onkeypress="return justNumbers(event);">
					...
					<!-- Fin datos cliente -->
						...
						<!-- Inicio datos adicionales - 4 columnas -->
					<div id="datosAdicionales" class="panel panel-primary" style="display: none;">
						<div class="panel-heading">Datos Adicionales</div>
						<div class="panel-body">
							<table>
								<tr>
									<td style="width: 15%"><label><b>Fecha de Compra:*</b></label></td>
									<td style="width: 35%"><input id="txtfechaCompra" name="txtfechaCompra" type="date" required="required" onblur="validacionFechaCompraAutoconsa();" class="datosVehiculo"></td>
									<td>
									<table>
										<tr>
										<td><label><b>D&iacute;a mes Pago:*</b></label></td>
										<td>
											<select class="mes_pago" id="mes_pago" required="required" onchange="validacionDiaMesAutoconsa()">
												<option value="1">1</option>
												<option value="16">16</option>	
											</select>
										</td>
										<td style="width: 15%"><label><b>D&iacute;as Extras:*</b></label></td>
										<td style="width: 35%"><input type="number" id="txtDiasExtras" name="txtDiasExtras" min="1" step="1" max="30"></td>
										</tr>								
									</table>
									</td>		 	
								</tr>								
						...
						<div id="tabbable" class="tabbable" style="display: none;">
							<ul class="nav nav-tabs">
								...
								<li><a href="#cuarto" data-toggle="tab" id="tabFormasPago">Formas
										de Pago</a></li>
								  <li><a href="#quinto" data-toggle="tab">Beneficiario y Asegurado
										</a></li>  
							</ul>
									...
									<!-- ---------------------------------------------------------------------------------------------------------------------- -->
										...
										<tr>
											<td colspan="5" align="center"><button type="button"
													...
													onclick='guardarSolicitudInspeccionInterna()'>Guardar</button>
												<button type="button"
													class="btn btn-primary bloquearEmitido" hidden=""
													id="actualizar-estado-solicitud-inspeccion-interna"
													onclick='cargarEstadoInspeccion()'>Actualizar
													Estado</button>
													<div id="loading_solicitud_inspeccionInterna" hidden="">
								...
								<tr>
									<td>
										<div class="alert alert-info" id="mensajeTramite"
											hidden="hidden" style="display: block;"></div>
									</td>
								</tr>
								<tr>
									...
									<option value='2'> Formato de d̩bito bancario. </option>
