...
<title>Grupo Producto - CotizadorQBE</title>
...
<script>
	...
	$(document)
			.ready(
					function() {
						activarMenu("GrupoProducto");

						$
								.ajax({
									url : '../GrupoProductoController',
									data : {
									...
									success : function(data) {
										...
										if (data.numRegistros > 0) {
													...
													.each(
															...
															function(index) {
																$(
																		...
																		.append(
																				"	<tr class='odd gradeX'>"
																						+ "<td relation='nombre'>"+ listadoGrupoProducto[index].nombre + "</td>"+
																						"<td relation='descripcion'>"+ listadoGrupoProducto[index].descripcion + "</td>"+
																					    "<td relation='activo'>"+ listadoGrupoProducto[index].activo + "</td>"+																						
																						" <td width='175px'>" +
																						" <input type='hidden'  value='"+ listadoGrupoProducto[index].codigo +"'/>" +
											...
											$(".eliminar-btn").bind({click: function() {
													var r = confirm("Seguro que desea eliminar el Grupo Producto " + $(this).parent().parent().children().first().text());
													if (r == true){
				...
				<div class="modal-content">
					<form id="formCrud">
						...
						<div class="modal-body">
							<div class="alert alert-success" id="msgPopup">El Grupo Producto se
								grabo con exito.</div>
