...
<head>
	...
	<title>TipoExtra - CotizadorQBE</title>
			...
			$.ajax({
				...
				success : function(data) {
					...
					if(data.numRegistros > 0){
						var listadoTipoExtra = data.listadoTipoExtra;
						$.each(listadoTipoExtra, function(index){
							$("#dataTableContent").append("	<tr class='odd gradeX'>" +
									" <td relation='codigoEnsurance'>"+ listadoTipoExtra[index].codigoEnsurance +"</td>" +
									" <td relation='nombre'>"+ listadoTipoExtra[index].nombre +"</td>" +
									" <td relation='activo'>"+ listadoTipoExtra[index].activo +"</td>" +
									" <td width='175px'>" +
										" <input type='hidden' value='"+ listadoTipoExtra[index].codigo +"'/>" +
				...
				<div class="modal-content">
					<form id="formCrud">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModalLabel">Nueva TipoExtra</h4>
						</div>
						<div class="modal-body">
							<div class="alert alert-success" id="msgPopup">El tipo de extra se grabo con exito.</div>
							<div class="form-group">
								...
								<label>Nombre del tipo de extra</label> 
