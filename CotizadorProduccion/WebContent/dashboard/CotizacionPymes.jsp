											...
											<table style="width: 100%">
												...
												<tr>
													...
													<td colspan="5"><select name="giro_negocio"
														id="giro_negocio" required="required"
														class="datosPymes"></select></td>
												</tr>
												<tr>
													<td>&nbsp;</td>
												...
												<tr>
													...
													<td><input id="numero_total_pisos"
														type="text" required="required"
														data-min="1" data-max="25" style="width: 70px"></input></td>
			
													<td>Año de Construcción:</td>
													<td><input id="anio_construccion" required="required"
														type="text" data-min="1" data-max="25" style="width: 70px"></input></td>
												</tr>
												<tr>
													<td>&nbsp;</td>
												</tr>
												<tr>
													<td>Material Construcción:</td>
													<td colspan="6"><select name="tipo_construccion"
														id="tipo_construccion" required="required"></select></td>
												</tr>
												<tr>
													<td>&nbsp;</td>
												</tr>
								...
								<div class="tab_strip_direccion" align="center">
									<table style="width: 80%">
										...
										<tr id="riesgoVolcanColumn">
											<td>¿A qué distancia se encuentra el bien asegurado de la zona de exposición de lahares V. Cotopaxi? (km)</td>
										...
										<tr id="fila_muebles_enseres" hidden="true">
											<td><label id="lblEtiquetaMuebles">Muebles, enseres y equipos de oficina:</label></td>
										...
										<tr id="fila_contenidos" hidden="true">
											<td>Contenidos:</td>
											<td><input type="text" name="valor_contenidos"
												id="valor_contenidos" class="datosPymes"
												onchange="calcularTotalValorAsegurado()"></input></td>
										</tr>
										<tr>
											<td>&nbsp;</td>
										...
										<tr>
											...
											<td align="center"><button
													...
													style="visibility: hidden; width: 200px">Ingresar Nuevo Valores</button></td>
										</tr>
										<tr>
											<td>&nbsp;</td>
										</tr>
		...
		<form id="wizard">
							...
							<table>
								...
								<tr id="filaNatural">
									...
									<td style="width: 35%"><input type="text" id="apellidos"
										class="datosPymes" name="apellidos" required="required"></td>								</tr>
						...
						<div class="thumbnail" style="padding: 20px;">
							<table id="inspeccion_tabla_detalle_pagos"
								...
								<tr>
									...
									<input id="inspeccion_total" class="total_vh"
			...
			<section>
				...
				******************************************************************************************************************-->
				...
				<fieldset class="border">
					<legend class="border">Datos del Solicitante y de
						Facturación</legend>
					<!-- Inicio datos poliza - 4 columnas -->
			...
			<section>
				...
				<div class="panel panel-primary" id="datosFinales">
					...
					<div class="panel-body">
						<table id="tablaBotonesFinal">
							<tr>
								<td colspan="4"><label id="lbl_FechaVigencia">Seleccione la fecha con la que desea que se emita la poliza de esta cotizaci&oacute;n: </label></td>
							...
							<tr>
								<td>
									...
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<button type="button" id="imprimirEndosoBeneficiario" hidden="hidden"
										class='btn btn-success btn-xs'>
										<span class='glyphicon glyphicon glyphicon-check'></span>Imprimir Endoso Beneficiario
									</button>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									...
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<button type="button" id="solicitarAutorizacion" hidden="hidden"
										class='btn btn-success btn-xs'>
										<span class='glyphicon glyphicon glyphicon-check'></span>Solicitar Autorización por fecha.
									</button>
								</td>
							</tr>
						</table>						
