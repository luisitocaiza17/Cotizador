...
<head>
	...
	<script>
		...
		$(document).ready(function() {
			activarMenu("CotizacionesConInspeccionPymes");		 	
			 $('#dataTable').hide();
	 						...
	 						$.each(listadoCotizacion, function(index){
	 							...
	 							" <td width='80px' align='center'>" +
	 								...
	 								" <button type='button' class='btn btn-success btn-xs actualizar-btn'>" +
	   									" <span class='glyphicon glyphicon glyphicon-edit'></span> Ver Inspección" +
	 								" </button>" +
	 						...
	 						$('#dataTable').dataTable( {	 							
        						...
        						"fnDrawCallback": function( oSettings ) {
        							$(".actualizar-btn").bind({click: function(event) {
        								...
        								window.location.href='InspeccionRealizadaPymes.jsp?id='+id;					
        								}
        								});
        						    }
    						});
