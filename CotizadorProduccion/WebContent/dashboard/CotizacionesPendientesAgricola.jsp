...
<head>
	...
	<script>
		...
		$(document).ready(function() {
			activarMenu("CotizacionesPendientesAgricola");		 	
			 $('#dataTable').hide();
				...
				if(fechaInicio != "" && fechaFin=="" ){
	    		 ...
	    		 $.ajax({
	 				...
	 				data : {
	 					...
	 					"tipoConsulta" : "encontrarAprobadoPorCanal",
	 						...
	 						$('#dataTable').dataTable( {	 							
        						...
        						"fnDrawCallback": function( oSettings ) {
        							$(".actualizar-btn").bind({click: function(event) {
        								...
        								window.location.href='AgriCotizacionEditable.jsp?id='+id;					
        								}
        								});
        						    }
    						});
...
%>
	...
	<div class="well">
			<table class="table table-striped">
				...
				<tbody>
					<tr>
						<td width=500 >Busqueda por Cotizacion:</td>
						<td width=200>Cotizacion: </td>
						<td width=500>
						</td>
					</tr>
					<tr>
					...
					<td>
					<input type="text"
							data-date-format="dd-mm-yyyy" id="dp1">
					</td>
					<td>
						<input type="text"
					...
					<tr>
						...
						<td>
							<select id="punto_venta_session"></select>
						</td>
						<td>
						</td>
					</tr>				
