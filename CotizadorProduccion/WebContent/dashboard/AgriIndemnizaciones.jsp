...
<title>Indemnizaciones Agricola</title>
...
function GetQueryStringByParameter(name) {
	...
	function CargarCotizacion() {	
		...
		$("#grid").kendoGrid({
			...
			dataSource: {
                ...
                transport:{
                	read: {
                		url: "../AgriIndemnizacionesController",
                		data: {
                			"fInicio" : fechaInicio,
    						"fFinal" : fechaFin,
    						...
    						"CanalId":canalId,
    						"tipoConsulta" : "cargarIndemnizaciones"
    	  					}
                	}
            ...
            columns: [
				{ field: "id", title: "Id", width: "60px",headerAttributes: { style: "white-space: normal"}, hidden: true, exportar: true},
				{ field: "cotizacionId", title: "Id Cotización", width: "60px",headerAttributes: { style: "white-space: normal"}},
				{ field: "tramite", title: "Tramite", width: "60px",headerAttributes: { style: "white-space: normal"}},
				{ field: "canal", title: "Canal.", width: "60px",headerAttributes: { style: "white-space: normal"}},
				{ field: "puntoVenta", title: "Punto Venta" , width: "100px",headerAttributes: { style: "white-space: normal"}},
				{ field: "identificacion", title: "Identificación" , width: "100px",headerAttributes: { style: "white-space: normal"}},
				{ field: "cliente", title: "Cliente" , width: "100px",headerAttributes: { style: "white-space: normal"}},
				{ field: "fechaProceso", type:"date", format:"{0:dd/MM/yyyy}", title: "Fecha de Proceso", width: "100px",headerAttributes: { style: "white-space: normal"}},
				{ field: "fechaPago", type:"date", format:"{0:dd/MM/yyyy}", title: "Fecha de Pago", width: "100px",headerAttributes: { style: "white-space: normal"}},
				{ field: "fechaNotificacionCliente",title: "fecha Notificacion Cliente", type:"date", format:"{0:dd/MM/yyyy}", width: "100px",headerAttributes: { style: "white-space: normal"}},
				{ field: "hectareas", title: "Hectareas", width: "100px",headerAttributes: { style: "white-space: normal"}},
				{ field: "sumaAseguradaIndemnizacion", title: "Suma Asegurada Indemnizacion", width: "80px",headerAttributes: { style: "white-space: normal"}},
				{ field: "valorIndemnizacion", title: "Valor Indemnizacion", width: "120px",headerAttributes: { style: "white-space: normal"}},	
				{ field: "tipoIndemnizacion", title: "Tipo de Indemnización", width: "120px",headerAttributes: { style: "white-space: normal"}},
	...
	function fnEventoClick(e) {
        ...
        var dataItem = this.dataItem($(e.currentTarget).closest("tr"));       
        $('#add').modal('show');
        actualizar(dataItem.cotizacionId);
    }
...
%>
	...
	<!-- Table -->
	<div class="row crud-nav-bar" id="reporteIndemnizacion">
		<div class="well">
			<div class="row">		
