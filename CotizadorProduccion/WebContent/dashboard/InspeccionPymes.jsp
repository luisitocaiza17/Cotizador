			...
			<div class="modal-content">
				<form id="formCrud">
					...
					<div class="modal-body">
						<div class="alert alert-success" id="msgPopup">La configuración se grabo con éxito.</div>
						<div id="tabstrip">
							...
							<div class="tab_strip_direccion" align="center">
								...
								<table>
									<tr>
										...
										<td>
											<input type="date" id="fecha_inspeccion" name="fecha_inspeccion" required="required">
										</td>
									...
									<tr>
										...
										<td><select name="tipo_ocupacion" id="tipo_ocupacion"
											style="width: 300px" required="required"></select></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
									</tr>
									...
									<tr>
										<td colspan="4">
											<table style="width: 100%">
												<tr>
													<td>Extintores:&nbsp;&nbsp;&nbsp;<input
														type="checkbox" id="tiene_extintores"
														name="extintores"></td>
													<td>Detectores de humo:&nbsp;&nbsp;&nbsp;<input
														type="checkbox" id="tiene_detector_humo"
														name="tiene_detector_humo"></td>
													<td>Sprinklers:&nbsp;&nbsp;&nbsp;<input
														type="checkbox" id="tiene_spinklers"
														name="tiene_spinklers"></td>
												</tr>
												<tr>
													<td>&nbsp;</td>
												</tr>
												<tr>
													<td>Alarma Monitoreada:&nbsp;&nbsp;&nbsp;<input
														type="checkbox" id="tiene_alarma_monitoreada"
														name="tiene_alarma_monitoreada"></td>
													<td>Guardian&iacute;a:&nbsp;&nbsp;&nbsp;<input
														type="checkbox" id="tiene_guardiania"
														name="tiene_guardiania"></td>
												</tr>
											</table>
										</td>
									</tr>
							...
							<div class="tab_strip_direccion" align="center">
								...
								<table style="width: 90%">
									<tr>
										<TD>Latitud:</TD>
										<TD><INPUT id="txt_Latitud" TYPE="TEXT" CLASS="required"
											NAME="gpsX" /></TD>
										<TD>Longitud:</TD>
										<TD><INPUT id="txt_Longitud" TYPE="TEXT"
											CLASS="required" NAME="gpsY" /></TD>
										<td>
											...
											<div class="col-lg-12">
												...
												<table width="80%">
														...
														<tr >
															...
															<tr>
																<td><button id="btnExportar" class="btn btn-primary"  onclick="exportarInforme()">Descargar Informe</button></td>
															</tr>
														</table>
												</div>
											</div>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary"
							id="guardarNoAprobado" onclick='grabarInspeccion("2")'
							>Riesgo NO sugerido</button>
						<button type="button" class="btn btn-primary" id="guardarAprobado"
							onclick='grabarInspeccion("1")'>Riesgo
							sugerido</button>
					</div>
				</form>
			</div>
