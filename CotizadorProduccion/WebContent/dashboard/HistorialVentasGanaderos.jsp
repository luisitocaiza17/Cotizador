...
<head>
    ...
    <title>Historial de Ventas - CotizadorQBE</title>
		...
		$(document).ready(function() {
			...
			$.ajax({
				...
				data : {
					...
					"fFinal" : finMes,
					"codigoTipoObjeto": "7",
					"tipoConsulta" : "encontrarTipoObjetoPorEstado",
						...
						$.each(listadoCotizacion, function(index){
							...
							" <td width='80px' align='center'>" +
								...
								" <button type='button' class='btn btn-success btn-xs actualizar-btn'>" +
  									" <span class='glyphicon glyphicon glyphicon-search'></span> Consultar" +
								" </button>" +
					...
					function enviarDatosFecha(fInicio, fFinal){				
						$.ajax({
							...
							data : {
								...
								"tipoConsulta" : "encontrarTipoObjetoEmitido"
							},
							type : 'POST',
							datatype : 'json',
							success : function(data) {					
