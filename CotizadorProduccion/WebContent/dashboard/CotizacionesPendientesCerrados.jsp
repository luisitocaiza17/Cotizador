	    	 ...
	    	 $('#ConsultaBtn').click(function(){
	 					...
	 					if(listadoCotizacion.length > 0){
	 						$.each(listadoCotizacion, function(index){
	 							...
	 							" <td width='80px' align='center'>" +
	 								...
	 								" <button type='button' class='btn btn-success btn-xs actualizar-btn' onClick='actualizar(event,"+listadoCotizacion[index].es_masivo+")'>" +
	   									" <span class='glyphicon glyphicon glyphicon-edit' ></span> Actualizar" +
	 								" </button>" +
	 								" <button type='button' class='btn btn-danger btn-xs eliminar-btn' onClick='eliminar(event)'>" +
				...
				//Metodo validacion de fechas buscador
		    		$(function(){
						...
						function actualizar(event,masivo) {
							...
							if(!masivo){
							// Modificar cuando se agregue un nuevo tarificador
							...
							if($(target).parent().prev().prev().prev().prev().prev().prev().text() == "Vehiculos Cerrados Publicos")
								...
								// Modificar cuando se agregue un nuevo tarificador
								if($(target).parent().prev().prev().prev().prev().prev().prev().text() == "Vehiculos Livianos")
									window.open('Cotizacion.jsp?id='+id+"&carga=%20masivos&carga2=%20grupal"+'&v=V'+$(target).parent().prev().text());
								if($(target).parent().prev().prev().prev().prev().prev().prev().text() == "Vehiculos Livianos")
									window.open('Cotizacion.jsp?id='+id+"&carga=%20masivos&carga2=%20grupal"+'&v=V'+$(target).parent().prev().text());
								
								if($(target).parent().prev().prev().prev().prev().prev().prev().text() == "Vehiculos Cerrados Livianos")
									window.open('CotizacionLivianos.jsp?id='+id+"&carga=%20masivos&carga2=%20grupal"+'&v=V'+$(target).parent().prev().text());							
								
								if($(target).parent().prev().prev().prev().prev().prev().prev().text() == "Vehiculos Cerrados Motos")
									window.open('CotizacionMotos.jsp?id='+id+"&carga=%20masivos&carga2=%20grupal"+'&v=V'+$(target).parent().prev().text());
								
								if($(target).parent().prev().prev().prev().prev().prev().prev().text() == "Vehiculos Cerrados Pesados")
									window.open('CotizacionPesados.jsp?id='+id+"&carga=%20masivos&carga2=%20grupal"+'&v=V'+$(target).parent().prev().text()); 
								
								if($(target).parent().prev().prev().prev().prev().prev().prev().text() == "Vehiculos Cerrados Publicos")
									window.open('CotizacionPublicos.jsp?id='+id+"&carga=%20masivos&carga2=%20grupal"+'&v=V'+$(target).parent().prev().text());
							}
							}
