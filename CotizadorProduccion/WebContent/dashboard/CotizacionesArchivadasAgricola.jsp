...
<title>Cotizaciones Agr&iacute;cola Archivadas- CotizadorQBE</title>
...
function GetQueryStringByParameter(name) {
	...
	var estadoConsulta="CA";//GetQueryStringByParameter('State');
	var codigo = "";
	var tipoConsulta = "";
	var Reglas = "";
	...
	$(document).ready(function() {
			activarMenu("CotizacionesArchivadasAgricola");
			...
			$('#Exportar').click(function(){
				...
				generarReporteCotizacion(cotizacionId,NroTramite,identificacion,ApellidosCliente,fechaInicio,fechaFin,tipoObjeto,puntoVenta,canalId,agente,misCotizaciones,pendientesImprimir);
			});
	...
	function Cargar() {
		...
		$("#grid").kendoGrid({
                ...
                transport:{
                	read: {
                		...
                		data: {
    						...
    						"tipoConsulta" : "encontrarArchivadas",
            ...
            columns: [
                      { field: "id", title: "No.", width: "60px"},
                      { field: "NumeroTramite", title: "Nro. Trámite", width: "80px",headerAttributes: { style: "white-space: normal"}},
                      { field: "CanalNombre", title: "Canal", width: "80px"},
                      { field: "PuntoVenta", title: "Punto Venta", width: "120px"},
                      { field: "IdentificacionCliente", title: "Identificación Cliente", width: "90px",headerAttributes: { style: "white-space: normal"}},
                      { field: "NombresCliente", title: "Nombres Cliente", width: "100px",headerAttributes: { style: "white-space: normal"}},
                      ...
                      { field: "DireccionSiembra", title: "Sitio", width: "100px"},
                      { field: "fechaSiembra", title: "Fecha Siembra",format: "{0:yyyy/MM/dd}", width: "100px",headerAttributes: { style: "white-space: normal"}},
                      { field: "sumaAseguradaTotal", title: "Suma Asegurada", width: "70px",headerAttributes: { style: "white-space: normal"}, hidden: true, exportar: true},
	...
	function generarReporteCotizacion(cotizacionId,NroTramite,identificacion,ApellidosCliente,fechaInicio,fechaFin,tipoObjeto,puntoVenta,canalId,agente,misCotizaciones,tieneObservaciones) {
		window.open('../AgriReportePOI?tipoConsulta=encontrarArchivadas&cotizacionId=' + cotizacionId+ 
				'&NroTramite='+NroTramite+
				'&identificacion='+identificacion+
				'&ApellidosCliente='+ApellidosCliente
				...
				'&estadoConsulta=CE&codigoTipoObjeto=8');
									...
									<tr>
										<td>
											<table border="1px">
												...
												<tr>
													<td style="color: blue;">Punto de Venta:</td>
													<td >
			...
			<table class="table">
				<thead>
					...
					<tr>
						...
						<th style="width: 100px">Punto Venta:</th>
					...
					<tr>
						...
						<th style="width: 300px"><select id="agente_session" data-placeholder="Seleccione una opción..."></select></th>
					</tr>
					<tr>
						<th style="width: 180px">&nbsp;</th>
					...
					<tr>
						...
						<th style="width: 300px"><input type="checkbox" id="mis_cotizaciones"></th>
						<th style="width: 100px">&nbsp;</th>
						<th style="width: 300px">&nbsp;</th>
					</tr>					
				</thead>
					...
					<tr>
						...
						<th>
							<button class="btn btn-primary" id="Exportar">
								<span class="glyphicon glyphicon-copy"></span> &nbsp; Exportar consulta
							</button>
						</th>	
					</tr>
				</tbody>
