...
<head>
	...
	<script>
		...
		$(document).ready(function() {
			activarMenu("CotizacionesPendientesDinamicos");		 	
			 $('#dataTable').hide();
	    	 ...
	    	 $('#ConsultaBtn').click(function(){
	    		 ...
	    		 if(tipoObjeto == "1" && cotizacionId=="" && fechaInicio == "" && fechaFin == "" && puntoVenta == "" && agente == "" && identificacion =="" && misCotizaciones ==false){
	 				...
	 				success : function(data) {					
	 					...
	 					if(listadoCotizacion.length > 0){
	 						$.each(listadoCotizacion, function(index){
	 							...
	 							" <td relation='version_tarificador'>"+ listadoCotizacion[index].version_tarificador +"</td>" +
							...
							window.open('Cotizacion.jsp?id='+id);							
							}
							});
				...
				<thead>
					<tr>
						<td colspan="3" style="font-weight: bold;"><center>Buscador
								Cotizaciones Vehiculos Dinamicos</center></td>
