...
<head>
	...
	<title>TipoVehiculo - CotizadorQBE</title>
					...
					if(data.numRegistros > 0){
						...
						$.each(listadoTipoVehiculo, function(index){
							$("#dataTableContent").append("	<tr class='odd gradeX'>" +
									" <td relation='codigoEnsurance'>"+ listadoTipoVehiculo[index].codigoEnsurance +"</td>" +
									" <td relation='nombre'>"+ listadoTipoVehiculo[index].nombre +"</td>" +
									" <td relation='activo'>"+ listadoTipoVehiculo[index].activo +"</td>" +
									" <td width='175px'>" +
										" <input type='hidden' value='"+ listadoTipoVehiculo[index].codigo +"'/>" +
				...
				<div class="modal-content">
					<form id="formCrud">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModalLabel">Nuevo Tipo de Vehiculo</h4>
						</div>
						<div class="modal-body">
							<div class="alert alert-success" id="msgPopup">El tipo de vehiculo se grabo con exito.</div>
